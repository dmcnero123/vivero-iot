...
// ✅ Ahora recibe UMBRALES como parámetro
function calcularAlertas(data, UMBRALES) {
  const alertas = []
  ...
  return (
    <div className={styles.resumenCard} style={{ borderTopColor: color }}>
      ...
      <div className={styles.resumenValue}>
        {value ?? '--'}
        <span className={styles.resumenUnit}>{unit}</span>
      </div>
